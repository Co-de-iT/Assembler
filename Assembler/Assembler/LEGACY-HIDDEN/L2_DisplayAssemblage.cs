...
{
    [Obsolete]
    public class L2_DisplayAssemblage : GH_Component
    {
            ...
            switch (displayMode)
            {
                ...
                case "Z Value": // zHeight
                    ...
                    Parallel.For(0, colors.Length, i =>
                    {
                        ...
                        colors[i] = Constants.ZHeightGradient.ColourAt(t);
                    });
                    break;
                ...
                case "Receiver Values":
                    ...
                    Parallel.For(0, colors.Length, i =>
                    {
                        colors[i] = Constants.ReceiverValuesGradient.ColourAt((AOa.AssemblyObjects.Branches[i][0].ReceiverValue - min) * factor);
                    });
                    break;
                case "Local Density": // Local Density
                    ...
                    Parallel.For(0, colors.Length, i =>
                    {
                        ...
                        colors[i] = Constants.DensityGradient.ColourAt(localDensities[i]);
                    });
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Resources.L_Display_Assemblage;
            }
        }
